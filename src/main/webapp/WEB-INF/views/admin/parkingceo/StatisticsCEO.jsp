									...
									<div class="table-responsive" style="overflow: hidden;">
										...
										<div id="pagingArea" align="center">
											...
											<c:if test="${pi.currentPage != 1}">
												<c:url var="blistFirst" value="selectStatisticsCEO.ad">
											...
											<c:if test="${pi.currentPage > 1}">
												<c:url var="blistBack" value="/selectStatisticsCEO.ad">
											...
											<c:forEach var="p" begin="${pi.startPage}"
												...
												<c:if test="${p ne pi.currentPage}">
													<c:url var="blistCheck" value="selectStatisticsCEO.ad">
											...
											<c:if test="${pi.currentPage < pi.maxPage}">
												<c:url var="blistEnd" value="selectStatisticsCEO.ad">
													<c:param name="currentPage" value="${pi.currentPage+1}" />
												</c:url>
											...
											<!-- 끝 페이지 -->
											<c:if test="${pi.currentPage != pi.maxPage}">
												<c:url var="blistEnd2" value="selectStatisticsCEO.ad">
			...
			function selectStatisticsMonth() {
				$.ajax({
					...
					success:function(data){
						...
						$("#ajaxGraph").append('<div align="left">올해 환전 금액 : '+sum+'원</div>');
			...
			function selectStatistics7Days() {
				$.ajax({
					...
					success:function(data){
						...
						$("#ajaxGraph").append('<div align="left">최근 7일 환전 금액 : '+sum+'원</div>');
			...
			function selectStatisticsToday() {
				$.ajax({
					...
					success:function(data){
						...
						$("#ajaxGraph").append('<div align="left">최근 24시간 환전 금액 : '+sum+'원</div>');
