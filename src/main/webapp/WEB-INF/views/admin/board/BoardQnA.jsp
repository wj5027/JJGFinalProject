															...
															<div class="row">
																<div class="form-group" style="margin-left: 1.5%;">
																	<input type="text" class="form-control" id="boardTitle"
																		name="memberId" placeholder="제목을 입력해주세요">
																</div>
															</div>
														</td>
													</tr>
												...
												<tr>
													...
													<td class="text-center">
														<button data-toggle="modal"
															...
															class="btn btn-info animation-on-hover btn-sm" onclick="selectNo(${varstatus.count - 1});">답변</button>
														&nbsp;&nbsp;
														<button data-toggle="modal"
		...
		<script>
			...
			$(function() {
				$("#answerBoard").click(function() {
					...
					//location.href = 'answerBoard.ad?memberNo='+ memberNo;
				});
			});
		</script>
		...
		<script>
			...
			$(function() {
				$("#deleteBoard").click(function() {
					...
					//location.href = 'deleteBoard.ad?memberNo='+ memberNo;
				});
			});
		</script>
