...
public class ParkingAdmin implements java.io.Serializable{
	...
	public String toString() {
		return "ParkingAdmin [parkingNo=" + parkingNo + ", parkingName=" + parkingName + ", operateType=" + operateType
				+ ", parkingType=" + parkingType + ", roadAddress=" + roadAddress + ", address=" + address
				+ ", parkingSize=" + parkingSize + ", openDays=" + openDays + ", weekdayStime=" + weekdayStime
				+ ", weekdayEtime=" + weekdayEtime + ", satStime=" + satStime + ", satEtime=" + satEtime
				+ ", hollydayStime=" + hollydayStime + ", hollydayEtime=" + hollydayEtime + ", priceInfo=" + priceInfo
				+ ", parkingNtime=" + parkingNtime + ", parkingNprice=" + parkingNprice + ", parkingAtime="
